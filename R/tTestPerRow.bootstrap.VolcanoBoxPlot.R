...
#' @param ylab="-log10(p-value)" Label for the Y axis
#' @param xlim=NULL    Range of the X axis. Automatically computed if NULL (default).
#' @param ylim=NULL    Range of the Y axis. Automatically computed if NULL (default).
